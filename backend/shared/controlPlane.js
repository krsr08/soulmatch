...
const DEFAULT_BEST_MATCH_AD_CARDS = [
  ...
  },
  {
    ...
    type: 'upgrade',
    enabled: true,
    targetPlans: ['free', 'bronze', 'silver'],
    minPlan: 'free',
    maxPlan: 'silver',
    theme: 'gold',
    badge: 'Recommended',
  ...
  },
  {
    ...
    type: 'upgrade',
    enabled: true,
    targetPlans: ['free', 'bronze', 'silver', 'gold'],
    minPlan: 'free',
    maxPlan: 'gold',
    theme: 'dark',
    badge: 'Elite access',
  ...
  },
  {
    ...
    bullets: ['Verified phone access', 'Privacy-first contact rules', 'Safer introductions'],
    cta: 'Unlock contacts',
    destination: 'membership'
  },
  {
    ...
    bullets: ['Higher listing priority', 'More profile views', 'Better response chances'],
  ...
  },
  {
    ...
    type: 'assist',
    enabled: true,
    targetPlans: ['silver', 'gold', 'platinum'],
    minPlan: 'silver',
    theme: 'peach',
